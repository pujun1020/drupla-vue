...
let formdata=ref<HTMLFormElement>()
const formfun=()=>{
    const data=Object.fromEntries(new FormData(formdata.value))
    console.log(data)
}
</script>
